  ...
  return (
    <div className="min-h-screen py-10">
      <div className="max-w-4xl mx-auto p-6 border rounded-lg shadow-lg">
        <h3 className="text-2xl font-semibold mb-8">⭐⭒Create BlᎧɢ⭒⭐</h3>
        <form onSubmit={handleCreateBlog} className="space-y-6">
          <div>
            <label className="block text-lg">Cαtᴇgory</label>
            <select
              value={category}
          ...
          <div>
            <label className="block text-lg">T𝔦tl𝔢</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-lg">Blog Imαgᴇ</label>
          ...
          <div>
            <label className="block text-lg">AbᎧut</label>
            <textarea
              rows="5"
